        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-neutral-600 mb-4 max-w-md">
              A modern React application built with the latest technologies and
              best practices for a seamless user experience.
            </p>
            <div className="flex space-x-4">
              <a
                href="#"
                className="text-neutral-400 hover:text-web-green-500 transition-colors"
              >
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link
                  to="#"
                  className="text-neutral-600 hover:text-web-green-600 transition-colors"
                >
                  Features
                </Link>
              </li>
